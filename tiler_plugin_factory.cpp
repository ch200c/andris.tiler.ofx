#include "pch.h"
#include "tiler_plugin_factory.h"
#include "tiler_plugin.h"			// tiler_plugin
#include "constants.h"
...
void tiler_plugin_factory::describe(
	OFX::ImageEffectDescriptor& desc) noexcept
{
	...
	OFX::ContextEnum context) noexcept
{
...

	{
		...
		parameter->setDefault(tiler::param_center_x_default, tiler::param_center_x_default);
		parameter->setDigits(3);
...
OFX::ImageEffect* tiler_plugin_factory::createInstance(
